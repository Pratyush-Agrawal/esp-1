...
ifstream f("/home/esp2020/pa2562/esp-fall20/accelerators/stratus_hls/cholesky/datagen/input.txt");
    if (!f) {
        cout << "Cannot open input file.\n";
        return;
    }
ifstream fo("/home/esp2020/pa2562/esp-fall20/accelerators/stratus_hls/cholesky/datagen/output.txt");
    if (!fo) {
        cout << "Cannot open input file.\n";
        return;
    }
