    ...
    const unsigned dct_istrue = 0;
    const unsigned output_rows = 11;
    const unsigned output_cols = 11;
    ...
    // Prepare input data
    std::ifstream fo("/home/esp2020/pa2562/esp-fall20/accelerators/vivado_hls/dct_idct/datagen/input.txt");
    std::ifstream f("/home/esp2020/pa2562/esp-fall20/accelerators/vivado_hls/dct_idct/datagen/output.txt");
    ...
    error_rate = (float)errors / (output_rows * output_cols);
    ...
    std::cout << "#*********************** Error Rate is " << (error_rate * 100) <<" *************************# \n" ;
    std::cout << "#*********** Elements with error are  within 5% of the total elements **********# \n" ;
    std::cout << "#*******************************************************************************# \n" ;
    std::cout << " \n" ; 
    }
    // Free memory
