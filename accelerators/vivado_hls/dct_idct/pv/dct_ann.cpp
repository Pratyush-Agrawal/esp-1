...
for(int a=0; a<8 ; a++){
  ...
  const double s0 = (cos(0)*sqrt(.5)/2)/(1       );  
  const double s1 = (cos(1.*M_PI/16)/2)/(-a5+a4+1);  
  const double s2 = (cos(2.*M_PI/16)/2)/(a1+1    );  
  const double s3 = (cos(3.*M_PI/16)/2)/(a5+1    );  
  const double s4 = s0;  
  const double s5 = (cos(5.*M_PI/16)/2)/(1-a5    ); 
  const double s6 = (cos(6.*M_PI/16)/2)/(1-a1    ); 
  const double s7 = (cos(7.*M_PI/16)/2)/(a5-a4+1 );  
